...
count = 29;%size(Objectivefunc,2);
Data = Objectivefunc(:,1:count);
load(['C:\Users\Fatem\OneDrive - Arizona State University\Projects\Adaptive\Bayesian Optimization\AP_BO_newsetup\DATA\4D\DATA\Subject',num2str(subnum),'\plots\UsedKs.mat']);
