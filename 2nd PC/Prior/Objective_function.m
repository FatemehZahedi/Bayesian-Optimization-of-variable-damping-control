...
for block = 1:2
    ...
    for Iteration = 1 : 10/section % This should be changed based on iteration that we are in
        clear measures
    ...
    %             end
        ...
        ftrialbased(Iteration+(block-1)*priornum,2) = b_LB(10);
        ftrialbased(Iteration+(block-1)*priornum,3) = b_UB(10);
        %---------------------------------------------------------------------------------------------
