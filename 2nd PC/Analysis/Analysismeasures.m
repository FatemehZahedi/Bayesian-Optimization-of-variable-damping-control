...
percentageImprove2 = (-(Newmeasures(3,:,1)- Newmeasures(1,:,1))./mean(Newmeasures([1 3],:,1)))*100;

percentageImprove2(5)= -percentageImprove2(5);
percentageImprove2(6) = -percentageImprove2(6);

save(['/home/fzahedi/Fatemeh/Adaptive/AP_BO_newsetup/DATA/Subject',num2str(subnum),'/plots/Subject',num2str(subnum),'.mat'],'percentageImprove','Newmeasures','Avemeasures','percentageImprove2');
